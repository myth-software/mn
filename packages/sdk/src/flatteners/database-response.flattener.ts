import { DatabaseObjectResponse, Schema } from '@mountnotion/types';
 ...
 * @returns flat database {@link Schema}
 */
export const flattenDatabaseResponse = ({
  ...
  return {
    ...
    options: createOptions(properties, ensure(flattenRichText(title))),
